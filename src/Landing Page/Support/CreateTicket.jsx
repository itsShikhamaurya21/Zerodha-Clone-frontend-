...
function CreateTicket() {
  return (
    <div className="container mt-5">
      <div className="row">
        <h3>To create a ticket, select a revelant topic</h3>
        ...
        <div className="col-4  mt-5 mb-5">
          ...
          <div className="mt-5">
            <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Login Credentatials</a><br />
        ...
        <div className="col-4  mt-5 mb-5">
          <h5 ><i class="fa-solid fa-signal"></i> &nbsp;Your Zerodha Account</h5>
          <div className="mt-5">
          ...
          <div className="col-4  mt-5 mb-5">
          <h5 ><i class="fa-regular fa-circle"></i> &nbsp;Console</h5>
          <div className="mt-5">
